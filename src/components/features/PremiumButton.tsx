...
export default function PremiumButton({ onClick }: PremiumButtonProps) {
  // Har safa ochilganda tasodifiy sparkle joylari
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 flex items-center gap-1.5">
        <FaCrown
          size={14}
          className="premium-crown drop-shadow-[0_0_6px_rgba(251,191,36,0.8)] group-hover:drop-shadow-[0_0_12px_rgba(251,191,36,1)] transition-all duration-300"
        />
